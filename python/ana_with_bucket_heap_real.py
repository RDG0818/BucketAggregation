import math
from ana_bucket_heap_real import ANABucketHeapReal, SearchNode
...
def anytime_nonparametric_astar(grid: Grid, start: Node, goal: Node, heuristic, alpha: float = 1.0, beta: float = 1.0):
    """Anytime Non-parametric A* (ANA*) search algorithm using a real-valued BucketHeap."""
    ...
    # Use the ANABucketHeapReal for the open set
    open_set = ANABucketHeapReal(alpha=alpha, beta=beta)
