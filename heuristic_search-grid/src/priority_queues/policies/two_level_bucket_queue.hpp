...
#include <utils/heap_ordered_set.hpp>
...
namespace priority_queue_policies
{
    ...
    public:
        ...
        using location_info = priority_queue_traits<value_type, two_level_bucket_queue>::location_info_type;
        ...
        using primary_bucket_type = utils::ordered_set<secondary_bucket_type>;
        // using primary_bucket_type = utils::heap_ordered_set<secondary_bucket_type>;
        using queue_type = utils::ordered_set<primary_bucket_type>;

        two_level_bucket_queue() : two_level_bucket_queue(PriorityPair(), ElementInfoAccessor())
        {}

        two_level_bucket_queue(PriorityPair priority_pair, ElementInfoAccessor elem_info) :
...
template<typename T>
class priority_queue_traits<T, priority_queue_policies::two_level_bucket_queue>
{
